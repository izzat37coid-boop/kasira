            ...
            {paymentStep === 'processing' && currentTx && (
              <div className="p-10 text-center">
                ...
                <div className="flex gap-4">
                  ...
                  <button onClick={simulatePayment} className="flex-[2] bg-slate-900 text-white font-black py-4 rounded-2xl shadow-xl hover:bg-slate-800 transition uppercase tracking-widest text-[10px]">Konfirmasi Pembayaran (Manual)</button>
                </div>
              </div>
            )}
